package com.example.arianitbalidemaj_greetingsapp
...
import com.example.arianitbalidemaj_greetingsapp.ui.theme.ArianitBalidemajGreetingsAppTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            ArianitBalidemajGreetingsAppTheme {
